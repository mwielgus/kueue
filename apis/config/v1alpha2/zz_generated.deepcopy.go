...
func (in *Performance) DeepCopyInto(out *Performance) {
	*out = *in
	if in.JobControllerWorkerCount != nil {
		in, out := &in.JobControllerWorkerCount, &out.JobControllerWorkerCount
		*out = new(int)
		**out = **in
	}
	if in.ClusterQueueControllerWorkerCount != nil {
		in, out := &in.ClusterQueueControllerWorkerCount, &out.ClusterQueueControllerWorkerCount
		*out = new(int)
		**out = **in
	}
	if in.LocalQueueControllerWorkerCount != nil {
		in, out := &in.LocalQueueControllerWorkerCount, &out.LocalQueueControllerWorkerCount
		*out = new(int)
		**out = **in
	}
	if in.ResourceFlavorControllerWorkerCount != nil {
		in, out := &in.ResourceFlavorControllerWorkerCount, &out.ResourceFlavorControllerWorkerCount
		*out = new(int)
		**out = **in
	}
	if in.WorkloadControllerWorkerCount != nil {
		in, out := &in.WorkloadControllerWorkerCount, &out.WorkloadControllerWorkerCount
		*out = new(int)
		**out = **in
	}
}
